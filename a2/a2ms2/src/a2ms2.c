...
/*
 ============================================================================
 Description : Contact management system.  Full error checking capabilities
 	 	 	   with all values entered.  If user exceeds the maximum text
 	 	 	   allowable for a specific entry it will be shortened and cleared
 	 	 	   from buffer.  This Milestone is a test to see that we have built
 	 	 	   all of our functions to work as intended. And I believe that we
 	 	 	   will be adding arrays of contacts for ms3 and ms4 of Assignment 2
 	 	 	   ... can't wait!!
 ============================================================================
 */
